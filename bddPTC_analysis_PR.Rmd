...
#### **Fig2D. bddPTC vs HK2 for Mg uptake (20 min)**
...
#### **Fig2D. stats -\> bddPTC vs HK2 for Mg uptake (20 min)**
...
LRP2passWBDF<-read.xlsx("Experimental_data.xlsx",  sheet = "LRP2_passWB") %>% subset(ID!="comment")
...
#### **Fig2A. AQP1 western blot**

################################# 

```{r AQP1WB, warning=F, message=F, fig.height=3.5, fig.width=4}
AQP1WBDF<-read.xlsx("Experimental_data.xlsx",  sheet = "AQP1WB") %>% subset(ID!="comment" & group!="PC1" & group!="PC2")
